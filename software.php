                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = $con->query($query);
                                        while($row = $result->fetch_assoc()){
                                            echo "<tr><td>".$row['id']."</td><td>".$row['fecha']."</td><td><a href=\"\" class='btn btn-outline-primary' onclick=''>Ver</a></td></tr>";
                                        }
                                    ?>
                                </tbody>
                            </table>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $result = $con->query($query);
                                        while($row = $result->fetch_assoc()){
                                            echo "<tr><td>".$row['target']."</td><td>".$row['nombre']."</td><td>".$row['fecha_vencimiento']."</td></tr>";
                                        }
                                    ?>
                                </tbody>
                            </table>
